...
const CreatePost = () => {
  ...
  // We get a randomPrompt then we will call the setForm state
  // to spread out the form to update the prompt to the randomPropt
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          {/* Creating a place where an Ai generated image will be shown 
              and also show a preview of the image in case it hasn't been already generated
          */}
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            {/* if there is a form.photo then we can show a self-closing tag
            that's going to have a source form.photo */}
            { form.photo ? (
              <img
                src={form.photo}
                alt={form.prompt}
        ...
        {/* Making our Generate button and wrapping it*/}
