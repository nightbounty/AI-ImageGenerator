    ...
    <section className='max-w-7x1 mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#222328] text-[32px]'>
          The Commnunity Showcase
        </h1>
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
        Browse through a collection of imaginative and visually stunning images generated by AI from the community!
        </p>
      </div>
          ...
          <>
            {searchText && (
              <h2 className='font-medium text-[#666e75] text-x1 mb-3'>
                Showing results for <span className='text-[#22232]'>{searchText}</span>
